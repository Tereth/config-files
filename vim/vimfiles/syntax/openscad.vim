...
syn keyword openscadCsgKeyword union difference intersection render intersection_for group
syn keyword openscadTransform scale rotate translate mirror multmatrix color minkowski hull projection linear_extrude rotate_extrude offset resize
